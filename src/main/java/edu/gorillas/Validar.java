...
public class Validar {
    ...
    //Validar todos estos datos String dni, String nombre, int edad, String direccion, String fechaIncorporacion
    ...
    public static String fecha(String fecha) {
        ...
        do {
            try {
                ...
                //Si la comparación no se cumlple lanza la excepción
                if (!mat.matches())
                    throw new Excep(Excep.FECHA_FORMATO_MAL);
                //Devolvemos el nombre
                return fecha;
            } catch (Excep e) {
                e.getMessage();
                System.out.println("Introduzca una fecha con formato: dd/mm/aaaa ");
